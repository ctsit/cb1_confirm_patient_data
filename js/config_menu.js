...
$(document).ready(() => {
  ...
  const setSourceCodebook = () => {
    ...
    $('tr[field="target_pid"]').find('select').on('change', () => {
  ...
  $modal.on('show.bs.modal', function () {
    if ($(this).data('module') !== CB1.modulePrefix) {
      return;
    }

    // TODO(mbentz-uf): Add comment explaining this check
    ...
    ExternalModules.Settings.prototype.resetConfigInstances = function () {
      ...
      if ($modal.data('module') !== CB1.modulePrefix) {
        return;
      }
